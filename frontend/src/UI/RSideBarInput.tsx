    ...
    <div className="relative">
      <form className="w-full" onSubmit={props.handleSubmit}>
        <div className="relative">
          ...
          <button
            type="submit"
            className=" cursor-pointer absolute right-2 top-1/2 transform -translate-y-1/2 p-1 text-gray-800 dark:text-slate-300 hover:text-gray-800 dark:hover:text-white hover:bg-purple-100/50 dark:hover:bg-purple-800/50 rounded-md transition-all duration-200 disabled:opacity-50"
            disabled={props.loading}
          >
            {props.loading ? (
