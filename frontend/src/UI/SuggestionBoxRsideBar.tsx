...
export function SuggestionBox(props: SuggestionBoxProps) {
  return (
    <div>
      <p className="text-xs font-semibold text-gray-800 mb-1.5 uppercase tracking-wide">
        Suggested Action
      </p>
      <button
        className="flex items-center bg-gradient-to-r from-white/70 to-purple-50/60 backdrop-blur-sm hover:from-white/90 hover:to-purple-50/80 border border-purple-300/30 rounded-lg px-3 py-2 text-xs w-full shadow-sm hover:shadow-md transition-all duration-200 disabled:opacity-50"
      ...
      >
        ...
        <span className="text-left flex-1 text-gray-800 truncate font-medium">
